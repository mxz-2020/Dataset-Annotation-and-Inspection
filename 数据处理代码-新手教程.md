...
> 例如cell_meta中的Tissue列中的0,1,2 分别对应f['uns']['Tissue_categories'][()]中的Airway，Distal和Trachea；
> 同理：Cell_group_categories, Cell_type_categories, phase_categories, sample_categories, orig.ident_categories, 等都可以和cell_meta中的列相对应；**所以，请务必结合两者补全cell_meta中的内容**
